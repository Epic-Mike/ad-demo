 ...
 * що вміщуються в габарити плейсмента; при достатній ширині показуються до 3 плиток однакового розміру у ряд
 * (кілька креативів з тим самим size чергуються A,B,A,…).
